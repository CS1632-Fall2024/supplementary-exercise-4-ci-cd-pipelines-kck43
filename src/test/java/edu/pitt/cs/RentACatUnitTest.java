...
public class RentACatUnitTest {
	...
	public void testListCatsNumCats0() {
		// TODO: Fill in
		assertEquals("listCats() on empty not empty", "", r.listCats());
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("listCats full is incorrect", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", r.listCats());
	}
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse("rename cat not in list true", r.renameCat(2, "Garfield"));
